...
try:
    ...
    try:
        ...
        raise ImportError("The 'regex' module is required but not available; install it with: pip install regex")
    warnings.warn("`regex` module not found; falling back to builtin `re` with limited Unicode support. Install `regex` for full compatibility.", ImportWarning)
    re = _re
